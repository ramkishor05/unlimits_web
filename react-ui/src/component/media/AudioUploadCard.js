...
class AudioUploadCard extends React.Component {
  state = {
    mainState: "initial", // initial
    imageUploaded: 0,
    bytes: '',
    selectedFile: this.props.audio,
    btn: true,
    fileObject: {
  ...
  handleUploadClick = (event) => {
    ...
    reader.onloadend = function (e) {
        ...
        this.props.setAudio(fileObject));
    }.bind(this);
     // Would see a path?
     ...
     <Grid container spacing={2}  fullWidth>
      ...
      <ImageUploadCard name={"posterName"}
        ...
        setImage={(value)=> {
          ...
          this.props.setAudio(this.state.fileObject);
   } }
        >
      </ImageUploadCard>
     </Grid>
...
export default withStyles(styles, { withTheme: true })(AudioUploadCard);
