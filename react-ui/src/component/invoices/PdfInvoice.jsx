import ReactPDF, { Document, Font, Page, Text,Image, StyleSheet, PDFViewer} from "@react-pdf/renderer";
...
const Quixote = () => (
  ...
  const PdfInvoice = () =>{
    return (ReactPDF.render(<PDFViewer> <Quixote /></PDFViewer>,"/hello.pdf" ))
  }
