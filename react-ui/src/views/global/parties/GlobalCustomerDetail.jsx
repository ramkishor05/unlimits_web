...
class GlobalCustomerDetail extends Component {
...
export default connect(mapStateToProps, { getCustSaleListByCustomer,addCustSale, editCustSale, deleteCustSale  })(GlobalCustomerDetail);